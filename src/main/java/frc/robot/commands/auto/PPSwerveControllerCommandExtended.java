...
public class PPSwerveControllerCommandExtended extends CommandBase {
  ...
  PPSwerveControllerCommandExtended::defaultLogError;
   ...
   */
  public PPSwerveControllerCommandExtended(
  ...
  public boolean isFinished() {
    return this.timer.hasElapsed(transformedTrajectory.getTotalTimeSeconds()+2.0);
  }
  ...
  public static void setLoggingCallbacks(
      ...
      BiConsumer<Translation2d, Rotation2d> logError) {
        PPSwerveControllerCommandExtended.logActiveTrajectory = logActiveTrajectory;
        PPSwerveControllerCommandExtended.logTargetPose = logTargetPose;
        PPSwerveControllerCommandExtended.logSetpoint = logSetpoint;
        PPSwerveControllerCommandExtended.logError = logError;
  }
}
